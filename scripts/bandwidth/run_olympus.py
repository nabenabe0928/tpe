...
from tpe.utils.tabular_benchmarks import AbstractBench, OlympusBench
...
parser.add_argument("--dataset_id", type=int, choices=list(range(10)))
args = parser.parse_args()

# FUNCS = [LCBench(dataset_id=i, seed=None) for i in range(8)]
FUNCS = [OlympusBench(dataset_id=args.dataset_id, seed=None)]
N_SEEDS = 10
MAX_EVALS = 200
N_INIT = 200 * 5 // 100
